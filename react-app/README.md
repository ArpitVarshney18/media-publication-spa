...
After running `npm start` **in the `react-app` directory**, your app will be automatically opened in your browser (at path http://localhost:3000/content/media_publication_spa/en/home.html). If you make edits, the page will reload.
